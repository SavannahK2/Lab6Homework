...
public class Main 
{
    ...
    {
    //Note: Variables, Scanner, and then User entered Variables. Next object and calculations.
    double length = 0, width = 0, area1 = 0, length2 = 0, width2 = 0, area2=0;
    
    Scanner keyboard = new Scanner(System.in);
    
    System.out.print ("Please enter the length of the first tract of land: ");
